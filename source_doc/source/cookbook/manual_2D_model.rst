...
-  A template for the fields (which describe their dimension and
   coordinates)
-  The Jacobian for implicits schemes. Here, we only use explicite one,
   we can drop the Jacobian computation
...
.. image:: manual_2D_model_files/manual_2D_model_7_1.png
...
.. image:: manual_2D_model_files/manual_2D_model_11_1.png
